...
function getVieHere() {
    ...
    vie.types.add('Gallery', [
                                     {id: 'imagen1', range: 'Text', min: 0, max: 1},
                                     {id: 'youtube', range: 'Text', min: 0, max: 1},
                                     {id: 'titulo', range: 'Text', min: 0, max: 1},
                                     {id: 'contenido', range: 'Text', min: 0, max: 1},
                                     ]);
    
    vie.types.add('Schedule', [
    ...
    vie.service('rdfa').setTemplate('Schedule', 'scheduleTipoRel', jQuery('#SectionSchedule').html());
    return vie;
}
